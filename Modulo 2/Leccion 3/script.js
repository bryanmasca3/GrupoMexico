  ...
  tarjetas: [
    ...
    },
    {
      ...
      image: "imagen/recurso1.jpg",
       carouselimg: false,
      narracion:
        " Estimula un enfoque proactivo: La Seguridad Basada en el Comportamiento fomenta una mentalidad proactiva hacia la seguridad en el lugar de trabajo. En lugar de simplemente reaccionar a los incidentes después de que ocurran, se trabaja en la prevención activa de comportamientos inseguros. ​",
    },
    {
      ...
      image: "imagen/recurso3.jfif",
       carouselimg: false,
      narracion:
        "Aumenta la participación del trabajador y el sentido de pertenencia: Al involucrar a los trabajadores en la identificación y corrección de comportamientos inseguros, se fortalece su sentido de responsabilidad y pertenencia a la organización. ​",
    },
    {
      text: "Promueve la cultura de autocuidado​​",
      src: "audio/audio_04.mp3",
      image: "imagen/capas.gif",
       carouselimg: false,
      narracion:
        "Promueve la cultura de autocuidado: La Seguridad Basada en el Comportamiento impulsa la idea de que la seguridad es responsabilidad de todos. Los trabajadores se convierten en defensores de su propia seguridad y la de sus compañeros. ​​",
    },
    {
      ...
      image: "imagen/ojo.gif",
       carouselimg: false,
      narracion:
        "Extiende y complementa el proceso tradicional de observación de seguridad: La Seguridad Basada en el Comportamiento amplía el enfoque de la observación de seguridad más allá de la simple identificación de condiciones inseguras. Se centra en los comportamientos de las personas y cómo estos pueden contribuir a la seguridad o al riesgo. ​",
    },
    {
      ...
      image: "imagen/Recurso4.png",
       carouselimg: false,
      narracion:
        "Conecta al liderazgo al sistema existente de administración de seguridad: Los líderes de la organización desempeñan un papel activo en la Seguridad Basada en el Comportamiento al respaldar y promover una cultura de seguridad. Esto crea un compromiso visible desde la cima de la organización. ",
    },
    {
      ...
      image: "imagen/recurso5.jfif",
       carouselimg: false,
      narracion:
        "Genera un valor personal por la seguridad: Los trabajadores comienzan a ver la seguridad como un valor personal, no solo como una obligación laboral. Esto se traduce en un mayor compromiso con la seguridad en el trabajo.​",
    },
  ],
};
