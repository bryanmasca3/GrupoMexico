  ...
  tarjetas: [
    {
      ...
      narracion:
        "Liderazgo autocrático: Aquí el líder tiene el control total. No suele escuchar las opiniones de los demás y toma decisiones por sí mismo.",
      carousel: [
        {
          text: "",
          src: "audio/audio_01_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo burocrático: En este estilo, se siguen las reglas al pie de la letra. Es útil para la gestión de la seguridad, donde se deben cumplir las reglas para cuidarnos y cuidar a los demás.​",
      carousel: [
        {
          text: "",
          src: "audio/audio_02_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo carismático: Estos líderes tiene la capacidad para escuchar a los demás y la mano firme para asumir la toma de decisiones.",
      carousel: [
        {
          text: "",
          src: "audio/audio_04_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo participativo: Aquí, el líder toma decisiones en conjunto con el equipo. Este estilo es ideal para fomentar el trabajo en equipo y priorizar la calidad sobre la cantidad. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_05_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo orientado a las personas: Estos líderes se centran en apoyar y desarrollar a sus equipos, fomentando la colaboración. Es un enfoque participativo que empodera a los miembros del equipo.",
      carousel: [
        {
          text: "",
          src: "audio/audio_06_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo natural: Aquí, el líder es un trabajador destacado, y hace participar a todos sus compañeros en la toma de decisiones. Es democrático y se basa en valores compartidos. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_07_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo orientado a la tarea: Este estilo se enfoca en lograr resultados y cumplir con las metas. Son buenos para planificar y organizar.​",
      carousel: [
        {
          text: "",
          src: "audio/audio_08_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo transaccional: Se basa en un acuerdo donde los miembros del equipo aceptan obedecer al líder a cambio de recompensas. El líder tiene poder para sancionar. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_09_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Liderazgo transformacional: Estos líderes inspiran a su equipo, transmitiendo su entusiasmo. Motivan y transforman a las personas. ",
      carousel: [
        {
          text: "",
          src: "audio/audio_10_1.mp3",
