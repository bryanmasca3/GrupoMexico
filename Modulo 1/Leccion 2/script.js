  ...
  tarjetas: [
    {
      ...
      narracion:
        "Delegar responsabilidades: Cuando delegas responsabilidades, estás demostrando confianza en los miembros de tu equipo. Esto les permite asumir un sentido de propiedad sobre su trabajo y sentirse valorados. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_01_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Reconocer el trabajo bien hecho: El reconocimiento es una poderosa herramienta de motivación. Asegúrate de valorar y elogiar el trabajo de tus colaboradores cuando lo hagan bien. Esto no solo refuerza su autoestima, sino que también los anima a seguir contribuyendo de manera positiva al equipo. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_02_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Estimular la comunicación: Fomenta un ambiente de trabajo donde la comunicación fluya libremente. La comunicación efectiva mejora la colaboración y previene malentendidos. Promueve la humildad y el compañerismo, evitando la rivalidad y el interés propio que pueden ser perjudiciales. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_03_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Establecer metas claras: Define objetivos claros, medibles y alcanzables para tu equipo. Cuando todos comprenden lo que se espera de ellos, es más probable que trabajen hacia esas metas. Asegúrate de que estos objetivos estén divididos en metas a corto, medio y largo plazo para mantener el enfoque. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_04_1.mp3",
    ...
    },
    {
      ...
      narracion:
        "Utilizar incentivos y premios: Reconoce el esfuerzo y el desempeño sobresaliente con incentivos y premios. Estos pueden ser tangibles, como reconocimientos o regalos, o intangibles, como elogios públicos. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_05_1.mp3",
    ...
    },
    {
      ...
      image: "imagen/img02.png",
      narracion:
        "Estimular la superación personal y profesional: Anima a tus colaboradores a buscar la superación personal y profesional, esto puedes lograrlo proporcionando oportunidades de formación, desarrollo y motivarlos a tomar la iniciativa en su crecimiento. Cuando ven que pueden avanzar y crecer en su carrera, se sentirán más comprometidos con su trabajo. ​",
      carousel: [
        {
          text: "",
          src: "audio/audio_06_1.mp3",
