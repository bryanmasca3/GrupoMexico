...
var data = {
  ...
  tarjetas: [
    {
      text: "BLOQUEO PERSONAL",
      textInner: "BLOQUEO PERSONAL",
      src: "audio/audio_01.mp3",
      image: "imagen/diapo-09.png",
      carouselimg: false,
      narracion:
        "Se refiere al bloqueo de la fuente de energía (eléctrica, mecánica, hidráulica, o de cualquier otro tipo) para poder aislar físicamente un solo equipo o sistema. ​",
    },
    {
      text: "BLOQUEO GRUPAL ​​",
      textInner: "BLOQUEO GRUPAL ​",
      src: "audio/audio_02.mp3",
      image: "imagen/diapo-11.png",
      carouselimg: false,
      narracion:
        "Se refiere al bloqueo de la fuente de energía de cualquier tipo, para poder aislar físicamente mas de un solo equipo o sistema a la vez. ​",
    },      
  ],
};
