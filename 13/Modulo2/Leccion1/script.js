...
var data = {
  ...
  tarjetas: [
    {
      text: "CANDADOS DE BLOQUEO",
      textInner: "CANDADOS DE BLOQUEO",
      src: "audio/audio_01.mp3",
      image: "imagen/diapo-09.png",
      carouselimg: false,
      narracion:
        "Los candados de bloqueo son los dispositivos de aseguramiento eléctrico para evitar de manera física que pueda reactivarse el flujo de corriente en los equipos, estos cuentan con una llave única que permanecerá guardada mientras se realiza las diversas labores de mantenimiento .​",
    },
    {
      text: "TARJETAS DE BLOQUEO​",
      textInner: "TARJETAS DE BLOQUEO",
      src: "audio/audio_02.mp3",
      image: "imagen/diapo-11.png",
      carouselimg: false,
      narracion:
        "Las tarjetas de bloqueo son los accesorios que visualizan la información del personal realizando la labor, además ayuda a alertar a los demás trabajadores que en ese equipo se esta realizando algún trabajo y la prohibición de activarlos de nuevo​.",
    },
    {
      text: "DISPOSITIVOS DE BLOQUEO​​​​",
      textInner: "DISPOSITIVOS DE BLOQUEO​",
      src: "audio/audio_03.mp3",
      image: "imagen/diapo-13 ISO 45001.gif",
      carouselimg: false,
      narracion:
        "Existen diversos tipos de barreras físicas denominados candados o sistemas de bloqueo como las pinzas, de válvula, cajas de bloqueo entre otras.​",
    },
   /*  {
      text: "ILO-OSH 2001​​",
