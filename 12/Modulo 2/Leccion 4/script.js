...
var data = {
  title: "Lección 6: ¿Qué hacer en caso de accidente por contacto eléctrico? ​",
  ...
  tarjetas: [
    {
      text: "Corte el suministro de energía eléctrica:",
      textInner: "",
      src: "audio/audio_01.mp3",
      image: "imagen/recurso5.jfif",
      carouselimg: false,
      narracion:
        "Corte el suministro de energía eléctrica: La primera medida es asegurarse de que la fuente de energía eléctrica esté apagada o desconectada. Esto puede implicar apagar interruptores, desenchufar equipos o utilizar dispositivos de bloqueo para aislar la energía. ​",
    },
    {
      text: "No toque inmediatamente al afectado:",
      textInner: "",
      src: "audio/audio_02.mp3",
      image: "imagen/recurso5.jfif",
      carouselimg: false,
      narracion:
        "No toque inmediatamente al afectado: Evite el contacto directo con la persona afectada hasta estar seguro de que no hay peligro eléctrico. Si la persona está en contacto con un conductor eléctrico, tocarla sin antes cortar la energía podría poner en peligro su vida y la suya. ​​",
    },
    {
      text: "Retire el contacto eléctrico con un objeto aislante:​​",
      textInner: "",
      src: "audio/audio_03.mp3",
      image: "imagen/recurso5.jfif",
      carouselimg: false,
      narracion:
        "Retire el contacto eléctrico con un objeto aislante: Si es posible y sin ponerse en peligro, use un objeto no conductor (como un palo de madera seco) para apartar a la persona del conductor eléctrico. No use objetos metálicos ni toque a la persona con las manos desnudas. ​​",
    },
    {
      text: "Verifique los signos vitales del accidentado:​",
      textInner: "",
      src: "audio/audio_04.mp3",
      image: "imagen/recurso5.jfif",
      carouselimg: false,
      narracion:
        "Verifique los signos vitales del accidentado: Una vez que la persona esté alejada de la fuente eléctrica, verifique si está consciente y respira. Revise si tiene pulso y signos de circulación. Si la persona no responde y no respira normalmente, debe iniciar maniobras de resucitación cardiopulmonar (RCP) si está capacitado para hacerlo. ​​",
    },
    {
      text: "Otorgue los Primeros Auxilios:",
      textInner: "",
      src: "audio/audio_05.mp3",
      image: "imagen/recurso5.jfif",
      carouselimg: false,
      narracion:
        "Otorgue los Primeros Auxilios: solo si estuviera capacitado y si fuere necesario: Si el accidentado presenta quemaduras, heridas u otros síntomas de lesiones, brinde los primeros auxilios adecuados si está capacitado para hacerlo. Siempre es recomendable contar con conocimientos básicos de primeros auxilios. ​​",
    },
    {
      text: "Traslade al accidentado al Centro Asistencial:​",
      textInner: "",
      src: "audio/audio_06.mp3",
      image: "imagen/recurso5.jfif",
      carouselimg: false,
      narracion:
        "Traslade al accidentado al Centro Asistencial: Luego de tomar las medidas inmediatas, llame a los servicios de emergencia o traslade al accidentado a un centro asistencial lo más pronto posible para recibir atención médica especializada. ​​",
    },
  ],
};
